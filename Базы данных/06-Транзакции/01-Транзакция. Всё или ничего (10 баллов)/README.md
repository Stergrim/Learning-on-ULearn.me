...
**Задание**
1. В блоке транзакции обнови полную сумму бронирования. Нужно вычесть стоимость перелетов удаляемого билета (используй подзапрос).
2. В этом же блоке транзакции попробуй удалить билет из таблице tickets. Транзакция завершится с ошибкой. Что произошло с полной стоимостью бронирования?
