...
Курс рассчитан на людей имеющих базовые знания в программировании. Начинается курс с основ языка: синтаксиса, конструкций и парадигм программирования. Далее рассматриваются популярные области применения языка python, такие как: анализ данных и веб-фреймворк Django.
